 ...
 * `~/.batch-24-multiag/autofinish` 나 `AUTO_BATCH_STATE_DIR` 같은 **기본값도 같은 잣대**로 본다.
 */
...
export const defaultStateDir = () => process.env.AUTO_BATCH_STATE_DIR || join(homedir(), '.batch-24-multiag', 'autofinish')
